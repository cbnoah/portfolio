...
export function Footer() {
    ...
    return (
        <footer className="w-full flex flex-col items-center justify-center xl:px-80 px-6 pb-16 pt-10 z-10 relative">
            <div
                className="w-full dark:bg-[#09090B]/45 bg-gray-200/45 rounded-3xl flex flex-col gap-8 py-10 px-8 md:px-14 border border-white/30 dark:border-dark/30 hover:border-white dark:hover:border-black hover:bg-gray-200 dark:hover:bg-[#09090B]/70 transition-all duration-300">
                {/* Header: Brand name & Back to Top button */}
                <div className="w-full flex flex-col justify-center items-center gap-4">
                    <span className={"text-2xl dark:text-white text-black"}>{t("endText")}</span>
                    <button
                        onClick={scrollToTop}
                ...
                <div className="w-full flex flex-col items-center gap-4">
                    <span
                        className="text-xs md:text-sm font-semibold jetbrains-mono uppercase tracking-wider text-gray-600 dark:text-gray-400">
                        {t("links")}
                    </span>
                ...
                <div
                    className="w-full flex flex-col sm:flex-row justify-between items-center gap-2 pt-4 border-t border-black/10 dark:border-white/10 text-xs md:text-sm jetbrains-mono text-gray-700 dark:text-gray-300">
