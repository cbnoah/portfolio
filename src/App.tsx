                ...
                <div className={"flex flex-col gap-70"}>
                    <div
                        ...
                        <div className="hidden flex-row justify-start items-center 2xl:flex">
                            <h1 className="text-black dark:text-white font-[Panchang-Variable] font-semibold text-[6.3rem] hover:font-black transition-all duration-300">CHARRIN</h1>
                            <div className={"flex flex-row"}>
                                <h1 className="text-black dark:text-white font-[Panchang-Variable] font-semibold text-8xl">-</h1>
                                <h1 className="text-black dark:text-white font-[Panchang-Variable] font-semibold text-8xl">-</h1>
                            </div>
                            <h1 className="text-black dark:text-white font-[Panchang-Variable] font-semibold text-[6.3rem] hover:font-black transition-all duration-300">BOURRAT</h1>
                        </div>
