    ...
    return (
        <div
            ...
            <div className={"w-full h-full flex flex-col gap-4"}>
                ...
                <div
                    className={"w-full flex flex-wrap items-center justify-start gap-2 sm:gap-4"}>{(tags !== null && tags !== undefined && tags.length > 0) && tags.map((tag, index) => {
                    return (
                        <div
                            className={`w-25 sm:w-32 flex flex-row items-center justify-start gap-2 px-2 py-1 text-sm sm:text-md font-medium jetbrains-mono text-left dark:bg-[#09090B]/50 bg-gray-100/80 rounded-xl border text-black dark:text-white`}
                            key={index}
                            style={{borderColor: tag.color}}>
                            <div className="shrink-0 flex items-center">
                                <tag.icon className={"size-4.5 sm:size-6"}/>
                            </div>
